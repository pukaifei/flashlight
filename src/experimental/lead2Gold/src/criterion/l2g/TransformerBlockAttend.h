...
class TransformerBlockAttend : public fl::Container {
 public:
  TransformerBlockAttend(
      int32_t modelDim,
      int32_t headDim,
      int32_t mlpDim,
      int32_t nHeads,
 ...
 private:
  ...
  double pLayerdrop_;
  bool usePosEmb_;
  std::shared_ptr<fl::Linear> w1_, w2_, wq_auto_, wk_auto_, wv_auto_, wf_auto_, wq2_, wk2_, wv2_, wf2_;
...
CEREAL_REGISTER_TYPE(w2l::TransformerBlockAttend);