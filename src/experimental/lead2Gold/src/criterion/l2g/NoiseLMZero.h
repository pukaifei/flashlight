...
public:
  ...
  virtual bool compare(int64_t sid1, int64_t sid2, NoiseTrieLabel *word) {
return true; }; virtual float score(int64_t sid) { return 0.; }; virtual void
zeroGrad() {}; virtual void accGradScore(int64_t sid, double gscore) {}; virtual
~NoiseLMZeroUnit() {};
};
*/
