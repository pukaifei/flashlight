...
class NoiseLMLetterSwapUnit : public NoiseLM {
 ...
 public:
  ...
  explicit NoiseLMLetterSwapUnit(
  ...
  std::vector<fl::Variable> params() const {
    return params_;
  };
  std::vector<fl::Variable> temp_params() const {
    return temp_params_;
  };
  bool allowInsertion() {
    return allowInsertion_;
  };
  bool allowDeletion() {
    return allowDeletion_;
  };
  bool allowSwap() {
    return allowSwap_;
  };
  const std::string& noiselmtype() {
    return noiselmtype_;
  };
  bool autoScale() {
    return autoScale_;
