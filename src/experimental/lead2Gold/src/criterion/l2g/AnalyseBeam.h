...
public:
  AnalyseBeam(NoiseTrie& keytrie, NoiseLMLetterSwapUnit& lm, long B, w2l::Dictionary& dict, double threshold=0);
  std::vector<fl::Variable> forward(fl::Variable emissions, fl::Variable transitions, fl::Variable noisy_target, fl::Variable knoisy_target, fl::Variable kclean_target);
